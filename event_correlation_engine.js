const PIPELINE_CONFIG = [
  {
    name: 'NEWS',
    weight: 0.18,
    description: 'Breaking media reports and field updates',
  },
  {
    name: 'ARTICLES',
    weight: 0.16,
    description: 'Long-form analysis and contextual reporting',
  },
  {
    name: 'SATELLITE_IMAGERY',
    weight: 0.22,
    description: 'Orbital imagery and movement pattern detection',
  },
  {
    name: 'TRAFFIC_DATA',
    weight: 0.17,
    description: 'Road, port, and logistics traffic anomalies',
  },
  {
    name: 'WEATHER_DATA',
    weight: 0.14,
    description: 'Storm, fog, and atmospheric disruption indicators',
  },
  {
    name: 'CONFLICT_ASSESSMENT',
    weight: 0.13,
    description: 'Ongoing conflict and escalation modeling',
  },
];
...
function calculateConsequenceProbability({
  weatherRisk,
  trafficRisk,
  conflictRisk,
  satelliteRisk,
...
function buildEventCorrelationSet() {
  const scenario = {
    ...
    probability: calculateConsequenceProbability({
      weatherRisk: 0.7,
      trafficRisk: 0.78,
      conflictRisk: 0.91,
      satelliteRisk: 0.83,
